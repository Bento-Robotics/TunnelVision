...
class BarcodeReader(Node):
    ...
    def __init__(self):
        ...
        self.subscription = self.create_subscription(String, 'cam1/barcode', self.barcode_callback, 10)
        self.subscription = self.create_subscription(String, 'cam2/barcode', self.barcode_callback, 10)
